...
class specs {
	...
	// lista array aggiornata al 01/03/2020
	...
	function specs( ttype, var, ttime ) 
	{
		if ( ttype == Transition.ToNewList  ) {
			...
			else if ( n3ds.find(system) > -1 ) {		// NINTENDO 3DS
				switch ( number ) {
			...
			else if ( at2.find(system) > -1 ) {			// ATARI 2600
				switch ( number ) {
			...
			else if ( at7.find(system) > -1 ) {			// ATARI 7800
				switch ( number ) {
			...
			else if ( atj.find(system) > -1 ) {			// ATARI JAGUAR
				switch ( number ) {
			...
			else if ( atl.find(system) > -1 ) {			// ATARI LYNX
				switch ( number ) {
			...
			else if ( ato.find(system) > -1 ) {			// ATOMISWAVE
				switch ( number ) {
					case 1:		text = "Atomiswave"; break;
					case 2:		text = "Manufacturer: Sammy Corporation"; break;
					case 3:		text = "Generation: Arcade"; break;
					case 4:		text = "Release: 2003-2009"; break;
					case 5:		text = "Units sold: ---"; break;
					case 6:		text = "Media: MASKED-ROM cartridge Max 128MB"; break;
					case 7:		text = "CPU: 32-bit Hitachi SH-4 RISC CPU @200MHz"; break;
					case 8:		text = "GPU: PowerVR 2 (PVR2DC) @100 MHz"; break;
					case 9:		text = "RAM: 16MB (64 Mbits SD-RAM x2)"; break;
					case 10:	text = "Display: 480p"; break;
					case 11:	text = "Colors: 16,770,000 (24bits)"; break;
					case 12:	text = "Sound: 32-bit  RISC CPU buil-in (64 channel ADPCM)"; break;
				}
			}
			else if ( col.find(system) > -1 ) {			// COLECOVISION
				switch ( number ) {
			...
			else if ( drc.find(system) > -1 ) {			// DREAMCAST
				switch ( number ) {
			...
			else if ( fds.find(system) > -1 ) {			// FAMICOM DISK SYSTEM
				switch ( number ) {
			...
			else if ( gg.find(system) > -1 ) {			// GAME GEAR
				switch ( number ) {
			...
			else if ( gb.find(system) > -1 ) {			// GAME BOY
				switch ( number ) {
			...
			else if ( gba.find(system) > -1 ) {			// GAME BOY ADVANCE
				switch ( number ) {
			...
			else if ( gbc.find(system) > -1 ) {			// GAME BOY COLOR
				switch ( number ) {
			...
			else if ( gc.find(system) > -1 ) {			// GAMECUBE
				switch ( number ) {
			...
			else if ( gen.find(system) > -1 ) {			// GENESIS
				switch ( number ) {
			...
			else if ( sms.find(system) > -1 ) {			// MASTERSYSTEM
				switch ( number ) {
			...
			else if ( n64.find(system) > -1 ) {			// NINTENDO 64
				switch ( number ) {
			...
			else if ( nao.find(system) > -1 ) {			// NAOMI
				switch ( number ) {
					case 1:		text = "Naomi"; break;
					case 2:		text = "Manufacturer: Sega"; break;
					case 3:		text = "Generation: Arcade"; break;
					case 4:		text = "Release: 1998-2009"; break;
					case 5:		text = "Units sold: ---"; break;
					case 6:		text = "Media: GD-ROM disc drive @12× 1GB per GD-ROM disc"; break;
					case 7:		text = "CPU: 32-bit Hitachi SH-4 @200MHz"; break;
					case 8:		text = "GPU: PowerVR 2 (PVR2DC) @100 MHz"; break;
					case 9:		text = "RAM: 32MB SDRAM main, 16MB SDRAM vram"; break;
					case 10:	text = "Display: 320×240 to 800×608 pixels"; break;
					case 11:	text = "Colors: 16,770,000 (24bits)"; break;
					case 12:	text = "Sound: 32-bit ARM7 RISC CPU @45MHz (64 channel ADPCM)"; break;
				}
			}
			else if ( nds.find(system) > -1 ) {			// NINTENDO DS
				switch ( number ) {
			...
			else if ( ncd.find(system) > -1 ) {			// NEO GEO CD
				switch ( number ) {
			...
			else if ( mvs.find(system) > -1 ) {			// NEO GEO MVS
				switch ( number ) {
					case 1:		text = "Neo Geo MVS"; break;
					case 2:		text = "Manufacturer: SNK"; break;
					case 3:		text = "Generation: Arcade"; break;
					case 4:		text = "Retail: 1990-2004"; break;
					case 5:		text = "Units sold: 1 million worldwide"; break;
					case 6:		text = "Media: JAMMA system"; break;
					case 7:		text = "CPU: 16-bit Motorola 68000 3µm @12MHz"; break;
					case 8:		text = "GPU: 24-bit SNK LSPC2-A2 @24MHz"; break;
					case 9:		text = "RAM: 64KB main, 84KB VRAM, 2KB Audio"; break;
					case 10:	text = "Display: 320x224 60Hz NTSC, 320x240 50Hz PAL"; break;
			...
			else if ( ngp.find(system) > -1 ) {			// NEO GEO POCKET
				switch ( number ) {
			...
			else if ( ngpc.find(system) > -1 ) {		// NEO GEO POCKET COLOR
				switch ( number ) {
			...
			else if ( od2.find(system) > -1 ) {			// ODYSSEY2
				switch ( number ) {
			...
			else if ( pce.find(system) > -1 ) {			// PC ENGINE
				switch ( number ) {
			...
			else if ( sat.find(system) > -1 ) {			// SATURN
				switch ( number ) {
			...
			else if ( s32x.find(system) > -1 ) {		// SEGA 32X
				switch ( number ) {
			...
			else if ( scd.find(system) > -1 ) {			// SEGA CD
				switch ( number ) {
			...
			else if ( cd32x.find(system) > -1 ) {		// SEGA CD 32X
				switch ( number ) {
			...
			else if ( sg1.find(system) > -1 ) {			// SEGA SG-1000
				switch ( number ) {
			...
			else if ( snes.find(system) > -1 ) {		// SNES
				switch ( number ) {
			...
			else if ( vec.find(system) > -1 ) {			// VECTREX
				switch ( number ) {
			...
			else if ( vrb.find(system) > -1 ) {			// VIRTUALBOY
				switch ( number ) {
			...
			else if ( wiiu.find(system) > -1 ) {		// WIIU
				switch ( number ) {
			...
			else if ( wsw.find(system) > -1 ) {			// WONDERSWAN
				switch ( number ) {
			...
			else if ( wsc.find(system) > -1 ) {			// WONDERSWAN COLOR
				switch ( number ) {
			...
			else if ( zxs.find(system) > -1 ) {			// ZX SPECTRUM
				switch ( number ) {
